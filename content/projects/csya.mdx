...
projectLink: https://csya-edu.org
---
...
-   **Tech Stack:** Migrated the site to Next.js, improving responsiveness and page speeds.
-   **Global Accessibility:** Optimized load times by 30% to support users in countries with limited bandwidth (e.g., Bangladesh, Indonesia, Egypt, Tanzania).
-   **Backend Infrastructure:** Shifted from static site hosting to Vercel, enhancing scalability.
-   **SEO Optimization:** Implemented structured metadata for better discoverability by search engines.

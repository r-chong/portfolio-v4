...
export default function Header() {
    ...
    return (
        ...
        >
            ...
            {/* Desktop Navigation */}
            <nav className='hidden sm:flex fixed top-[1.7rem] left-1/2 -translate-x-1/2 h-12 py-2'>
                <ul className='flex items-center text-[0.9rem] font-medium text-gray-500 dark:text-gray-400 w-[22rem] justify-around'>

    ...
    return (
        ...
        >
            ...
            <nav className='hidden sm:flex fixed top-[1.7rem] left-1/2 h-12 -translate-x-1/2 py-2'>
                <ul className='flex w-[22rem] flex-wrap items-center justify-center gap-y-1 text-[0.9rem] font-medium text-gray-500 dark:text-gray-400 sm:flex-nowrap sm:gap-5'>
                    {links.map((link) => {
            ...
            <AnimatePresence>
                {isMenuOpen && (
                    <motion.div
                        ...
                        exit={{ opacity: 0, y: -20 }}
                        transition={{ duration: 0.2 }}
                        className='fixed inset-0 bg-white dark:bg-gray-950 z-[998] sm:hidden pt-24 px-8'
                    >
